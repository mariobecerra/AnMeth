...
El mínimo error de validación se alcanza con el archivo `r paste('dimlat',errores[which(errores$erroresval==min(errores$erroresval, na.rm=TRUE)),4])` con un valor de `r errores[which(errores$erroresval==min(errores$erroresval, na.rm=TRUE)),3]`. Por esto, este será el que usemos como ganador.
